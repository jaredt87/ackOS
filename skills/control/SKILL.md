---
name: control
description: Use ackOS as the control boundary whenever an agent is about to make a side-effecting change. Route intent, constraints, execution authority, independent verification, and commit through an available ackOS integration instead of treating the model's own reasoning as authority.
---
...
6. If an ackOS integration, SDK, MCP tool, or other configured control endpoint is available, submit the transition through it before executing the side effect.
7. Do not treat the skill instructions, the model's own reasoning, or a proposed action as execution authority.
